...
export const privacyContent = {
        ...
        items: [
          {
            ...
            desc: 'Information you provide during onboarding, including your business name, WhatsApp Phone Number ID, and Meta Access Tokens.'
          },
          {
            sub: 'Automated WhatsApp Webhook Payloads',
            desc: 'Customer messages transmitted to our FastAPI endpoints via official Meta webhooks. These payloads contain sender phone numbers, timestamps, and message contents strictly required to generate contextual AI responses.'
          },
          {
            sub: 'Custom Knowledge Base & Product Catalogs',
            desc: 'Text documents, FAQs, and pricing rules uploaded to the Regalia dashboard to steer AI responses and regional dialects such as regional dialect adaptations.'
          }
        ]
      },
      {
        heading: '2. Strict Data Isolation & Local SQLite Storage',
        p: 'Unlike public AI chat interfaces, Regalia operates on strict enterprise data tenancy. All client configurations, access keys, and conversation logs are encrypted and stored locally in isolated SQLite storage. We guarantee that:',
        list: [
          'End-customer phone numbers and chat logs are strictly partitioned per business ID.',
          'No customer interaction data is ever sold, shared, or transferred to third-party advertising brokers.',
          'Your custom knowledge base is only accessible during inference requests specifically originating from your authorized WhatsApp Phone Number ID.'
        ]
      },
      {
        heading: '3. Google Gemini AI Model Processing',
        p: 'To generate intelligent, natural-language responses, incoming message text is processed using Google DeepMind\'s Gemini large language models. All inference calls utilize enterprise API endpoints protected by Transport Layer Security (TLS 1.3). Under our Google Cloud enterprise agreements, data transmitted for inference is strictly isolated and is not retained for public foundation model retraining.'
      },
      {
        heading: '4. Data Retention & Lifecycle Management',
        p: 'We retain conversation records and webhook event logs only for as long as your business maintains an active subscription. Upon account deactivation or termination, all associated WhatsApp access tokens, knowledge base entries, and customer interaction logs can be permanently purged upon request in accordance with applicable data protection regulations.'
      },
      {
        ...
        list: [
          ...
          'Credential Revocation: You may update or delete your Meta Access Tokens directly from the settings panel at any time.',
    ...
    sections: [
        ...
        items: [
          {
            ...
            desc: 'Informasi yang Anda berikan saat pendaftaran, termasuk nama bisnis, ID Nomor Telepon WhatsApp, dan Token Akses Meta.'
          },
          {
            sub: 'Payload Webhook WhatsApp Otomatis',
            desc: 'Pesan pelanggan yang dikirimkan ke endpoint FastAPI kami melalui webhook resmi Meta. Payload ini mencakup nomor telepon pengirim, stempel waktu, dan isi pesan yang secara ketat diperlukan untuk menghasilkan respons AI yang kontekstual.'
          },
          {
            sub: 'Basis Pengetahuan (Knowledge Base) & Katalog Produk Khusus',
            desc: 'Dokumen teks, FAQ, serta aturan harga produk yang diunggah ke dasbor Regalia untuk mengarahkan respons AI dan gaya bahasa lokal seperti penyesuaian dialek regional.'
          }
        ]
      },
      {
        heading: '2. Isolasi Data Ketat & Penyimpanan SQLite Lokal',
        p: 'Berbeda dengan antarmuka AI publik biasa, Regalia beroperasi dengan prinsip isolasi penyewa data enterprise yang sangat ketat. Seluruh konfigurasi klien, kunci akses, dan log percakapan dienkripsi dan disimpan di penyimpanan SQLite lokal terisolasi. Kami menjamin bahwa:',
        list: [
          'Nomor telepon pelanggan akhir dan riwayat percakapan dipisahkan secara ketat berdasarkan ID bisnis.',
      ...
      },
      {
        ...
        list: [
          ...
          'Pencabutan Kredensial: Anda dapat memperbarui atau menghapus Token Akses Meta langsung dari panel pengaturan kapan saja.',
        ...
        items: [
          {
            ...
            desc: 'Informationen, die Sie bei der Einrichtung angeben, einschließlich Ihres Unternehmensnamens, der WhatsApp-Telefonnummer-ID und der Meta-Zugriffstoken.'
          },
          {
            sub: 'Automatisierte WhatsApp-Webhook-Nutzlasten',
            desc: 'Kundenmitteilungen, die über offizielle Meta-Webhooks an unsere FastAPI-Endpunkte übertragen werden. Diese Nutzlasten enthalten Telefonnummern der Absender, Zeitstempel und Nachrichteninhalte, die für die Generierung kontextueller KI-Antworten zwingend erforderlich sind.'
          },
          {
            sub: 'Benutzerdefinierte Wissensdatenbank & Produktkataloge',
            desc: 'Textdokumente, FAQs und Preisregeln, die in das Regalia-Dashboard hochgeladen werden, um KI-Antworten und regionale Sprachstile wie regionale Dialektanpassungen zu steuern.'
          }
        ]
      },
      {
        heading: '2. Strikte Datenisolierung & lokaler SQLite-Speicher',
        p: 'Im Gegensatz zu öffentlichen KI-Chat-Schnittstellen arbeitet Regalia mit einer strikten Mandantentrennung für Unternehmensdaten. Alle Kundenkonfigurationen, Zugriffsschlüssel und Gesprächsprotokolle werden verschlüsselt und lokal in isoliertem SQLite-Speicher abgelegt. Wir garantieren:',
        list: [
          'Endkunden-Telefonnummern und Chat-Protokolle werden streng nach Geschäfts-ID getrennt.',
          'Es werden niemals Kundeninteraktionsdaten an Drittanbieter-Werbevermittler verkauft, weitergegeben oder übertragen.',
          'Ihre benutzerdefinierte Wissensdatenbank ist ausschließlich während Interferenzanfragen zugänglich, die von Ihrer autorisierten WhatsApp-Telefonnummer-ID ausgehen.'
        ]
      },
      {
        heading: '3. Verarbeitung durch Google Gemini KI-Modelle',
        p: 'Um intelligente, natürlichsprachliche Antworten zu generieren, wird eingehender Nachrichtentext mithilfe von Google DeepMinds großen Sprachmodellen Gemini verarbeitet. Alle Interferenzaufrufe nutzen Enterprise-API-Endpunkte, die durch Transport Layer Security (TLS 1.3) geschützt sind. Gemäß unseren Google Cloud-Unternehmensvereinbarungen werden zur Interferenz übermittelte Daten streng isoliert und nicht zum erneuten Training öffentlicher Foundation-Modelle gespeichert.'
      },
      {
        heading: '4. Datenspeicherung & Lebenszyklusmanagement',
        p: 'Wir bewahren Gesprächsdatensätze und Webhook-Ereignisprotokolle nur so lange auf, wie Ihr Unternehmen ein aktives Abonnement unterhält. Bei Deaktivierung oder Kündigung des Kontos können alle zugehörigen WhatsApp-Zugriffstoken, Wissensdatenbankeinträge und Kundeninteraktionsprotokolle auf Anfrage gemäß den geltenden Datenschutzgesetzen dauerhaft gelöscht werden.'
      },
      {
        ...
        list: [
          ...
          'Widerruf von Anmeldeinformationen: Sie können Ihre Meta-Zugriffstoken jederzeit direkt im Einstellungsbereich aktualisieren oder löschen.',
  ...
  fr: {
    ...
    intro: 'Regalia AI (ci-après dénommée la "Société") est une entreprise d\'automatisation de l\'IA d\'entreprise spécialisée dans les systèmes de service client autonomes, fiables et pilotables pour WhatsApp Business. Cette Politique de confidentialité décrit comment notre plateforme collecte, utilise, chiffre et isole les données personnelles lorsque vous interagissez avec notre portail, notre tableau de bord et nos points de terminaison d\'agent IA.',
    sections: [
      {
        ...
        items: [
          {
            ...
            desc: 'Informations fournies lors de l\'intégration, notamment le nom de votre entreprise, l\'identifiant de numéro de téléphone WhatsApp et les jetons d\'accès Meta.'
          },
          {
            sub: 'Charges utiles de webhook WhatsApp automatisées',
            desc: 'Messages clients transmis à nos points de terminaison FastAPI via les webhooks officiels de Meta. Ces charges utiles contiennent les numéros de téléphone de l\'expéditeur, les horodatages et les contenus des messages strictement nécessaires pour générer des réponses IA contextuelles.'
          },
          {
      ...
      },
      {
        ...
        p: 'Contrairement aux interfaces de chat IA publiques, Regalia fonctionne sur une isolation locative stricte des données d\'entreprise. Toutes les configurations client, clés d\'accès et journaux de conversation sont chiffrés et stockés localement dans un stockage SQLite isolé. Nous garantissons que :',
        list: [
          'Les numéros de téléphone des clients finaux et les journaux de chat sont strictement compartimentés par identifiant d\'entreprise.',
          'Aucune donnée d\'interaction client n\'est jamais vendue, partagée ou transférée à des courtiers publicitaires tiers.',
          'Votre base de connaissances n\'est accessible que lors des requêtes d\'inférence provenant spécifiquement de votre numéro de téléphone WhatsApp autorisé.'
        ]
      },
      {
        heading: '3. Traitement des modèles d\'IA Google Gemini',
        p: 'Pour générer des réponses intelligentes en langage naturel, le texte des messages entrants est traité à l\'aide des grands modèles de langage Gemini de Google DeepMind. Tous les appels d\'inférence utilisent des points de terminaison d\'API d\'entreprise protégés par Transport Layer Security (TLS 1.3). Conformément à nos accords d\'entreprise Google Cloud, les données transmises pour l\'inférence sont strictement isolées et ne sont pas conservées pour le réentraînement des modèles fondationnels publics.'
      },
      {
        heading: '4. Conservation des données et gestion du cycle de vie',
        p: 'Nous conservons les enregistrements de conversation et les journaux d\'événements webhook uniquement tant que votre entreprise conserve un abonnement actif. Lors de la désactivation ou de la résiliation du compte, tous les jetons d\'accès WhatsApp, entrées de base de connaissances et journaux d\'interaction associés peuvent être définitivement purgés sur demande conformément aux réglementations applicables.'
      },
      {
        ...
        list: [
          ...
          'Révocation des identifiants : Vous pouvez mettre à jour ou supprimer vos jetons d\'accès Meta directement depuis le panneau de configuration à tout moment.',
        ...
        items: [
          {
            ...
            desc: 'Informazioni fornite durante l\'attivazione, incluso il nome della tua azienda, l\'ID del numero di telefono WhatsApp e i Token di Accesso Meta.'
          },
          {
            sub: 'Payload Webhook WhatsApp Automatizzati',
            desc: 'Messaggi dei clienti trasmessi ai nostri endpoint FastAPI tramite webhook ufficiali Meta. Questi payload contengono numeri di telefono del mittente, timestamp e contenuti dei messaggi strettamente necessari per generare risposte IA contestuali.'
          },
          {
            sub: 'Base di Conoscenza e Cataloghi Prodotti Personalizzati',
            desc: 'Documenti di testo, FAQ e regole di prezzo caricati sulla dashboard di Regalia per guidare le risposte dell\'IA e i dialetti regionali come gli adattamenti dialettali regionali.'
          }
        ]
      },
      {
        heading: '2. Isolamento dei Dati e Archiviazione SQLite Locale',
        p: 'A differenza delle interfacce di chat IA pubbliche, Regalia opera su un rigoroso isolamento dei dati aziendali. Tutte le configurazioni dei clienti, le chiavi di accesso e i registri delle conversazioni sono crittografati e archiviati localmente in un database SQLite isolato. Garantiamo che:',
        list: [
          'I numeri di telefono dei clienti finali e i registri delle chat sono strettamente partizionati per ID aziendale.',
          'Nessun dato di interazione del cliente viene mai venduto, condiviso o trasferito a broker pubblicitari di terze parti.',
          'La tua base di conoscenza è accessibile solo durante le richieste di inferenza provenienti specificamente dal tuo numero di telefono WhatsApp autorizzato.'
        ]
      },
      {
        heading: '3. Elaborazione del Modello IA Google Gemini',
        p: 'Per generare risposte intelligenti in linguaggio naturale, il testo dei messaggi in arrivo viene elaborato utilizzando i grandi modelli di linguaggio Gemini di Google DeepMind. Tutte le chiamate di inferenza utilizzano endpoint API aziendali protetti da Transport Layer Security (TLS 1.3). In base ai nostri accordi aziendali con Google Cloud, i dati trasmessi per l\'inferenza sono rigorosamente isolati e non vengono conservati per il riaddestramento dei modelli di base pubblici.'
      },
      {
        heading: '4. Conservazione dei Dati e Gestione del Ciclo di Vita',
        p: 'Conserviamo le registrazioni delle conversazioni e i registri degli eventi webhook solo finché la tua azienda mantiene un abbonamento attivo. In caso di disattivazione o chiusura dell\'account, tutti i token di accesso WhatsApp associati, le voci della base di conoscenza e i registri delle interazioni con i clienti possono essere eliminati in modo permanente su richiesta in conformità con le normative applicabili.'
      },
      {
        ...
        list: [
          ...
          'Revoca delle credenziali: puoi aggiornare o eliminare i tuoi Token di Accesso Meta direttamente dal pannello delle impostazioni in qualsiasi momento.',
        ...
        items: [
          {
            ...
            desc: 'Información que proporciona durante la incorporación, incluido el nombre de su empresa, el ID del número de teléfono de WhatsApp y los tokens de acceso de Meta.'
          },
          {
            sub: 'Cargas Útiles de Webhook de WhatsApp Automatizadas',
            desc: 'Mensajes de clientes transmitidos a nuestros puntos de conexión de FastAPI a través de webhooks oficiales de Meta. Estas cargas útiles contienen números de teléfono del remitente, marcas de tiempo y contenidos de mensajes estrictamente necesarios para generar respuestas de IA contextuales.'
          },
          {
            sub: 'Base de Conocimientos y Catálogos de Productos Personalizados',
            desc: 'Documentos de texto, preguntas frecuentes y reglas de precios subidos al panel de Regalia para guiar las respuestas de la IA y los modismos regionales como las adaptaciones de dialectos regionales.'
          }
        ]
      },
      {
        heading: '2. Aislamiento Estricto de Datos y Almacenamiento Local en SQLite',
        p: 'A diferencia de las interfaces de chat de IA públicas, Regalia opera bajo un estricto aislamiento por inquilino empresarial. Todas las configuraciones del cliente, las claves de acceso y los registros de conversaciones se cifran y almacenan localmente en una base de datos SQLite aislada. Garantizamos que:',
        list: [
          'Los números de teléfono de los clientes finales y los historiales de chat están estrictamente particionados por ID de empresa.',
          'Ningún dato de interacción de clientes se vende, comparte o transfiere jamás a intermediarios publicitarios de terceros.',
          'Su base de conocimientos solo es accesible durante las solicitudes de inferencia que se originan específicamente en su número de teléfono de WhatsApp autorizado.'
        ]
      },
      {
        heading: '3. Procesamiento mediante Modelos de IA Google Gemini',
        p: 'Para generar respuestas inteligentes en lenguaje natural, el texto de los mensajes entrantes se procesa utilizando los grandes modelos de lenguaje Gemini de Google DeepMind. Todas las llamadas de inferencia utilizan puntos de conexión de API empresariales protegidos por Transport Layer Security (TLS 1.3). Según nuestros acuerdos empresariales con Google Cloud, los datos transmitidos para la inferencia están estrictamente aislados y no se retienen para el reentrenamiento de modelos base públicos.'
      },
      {
        heading: '4. Retención de Datos y Gestión del Ciclo de Vida',
        p: 'Conservamos los registros de conversaciones y los registros de eventos de webhooks únicamente mientras su empresa mantenga una suscripción activa. Al desactivar o cancelar la cuenta, todos los tokens de acceso de WhatsApp, las entradas de la base de conocimientos y los historiales de interacción con los clientes pueden ser eliminados permanentemente previa solicitud, de acuerdo con las normativas de protección de datos aplicables.'
      },
      {
        ...
        list: [
          ...
          'Revocación de credenciales: Puede actualizar o eliminar sus tokens de acceso de Meta directamente desde el panel de configuración en cualquier momento.',
        ...
        items: [
          {
            ...
            desc: 'Informações fornecidas durante o cadastro, incluindo o nome da sua empresa, o ID do número de telefone do WhatsApp e os Tokens de Acesso Meta.'
          },
          {
            sub: 'Payloads Automatizados de Webhook do WhatsApp',
            desc: 'Mensagens de clientes transmitidas para nossos endpoints FastAPI via webhooks oficiais da Meta. Esses payloads contêm números de telefone do remetente, carimbos de data/hora e conteúdos de mensagens estritamente necessários para gerar respostas contextuais de IA.'
          },
          {
            sub: 'Base de Conhecimento e Catálogos de Produtos Personalizados',
            desc: 'Documentos de texto, perguntas frequentes e regras de preços de produtos enviados ao painel da Regalia para orientar as respostas da IA e os dialetos regionais como adaptações de dialetos regionais.'
          }
        ]
      },
      {
        heading: '2. Isolamento Estrito de Dados e Armazenamento Local em SQLite',
        p: 'Diferente das interfaces públicas de chat com IA, a Regalia opera com base no isolamento estrito de inquilinos de dados corporativos. Todas as configurações dos clientes, chaves de acesso e registros de conversas são criptografados e armazenados localmente em banco SQLite isolado. Garantimos que:',
        list: [
          'Os números de telefone dos clientes finais e históricos de conversas são estritamente particionados pelo ID da empresa.',
          'Nenhum dado de interação do cliente é vendido, compartilhado ou transferido para corretores de publicidade terceirizados.',
          'Sua base de conhecimento é acessível apenas durante solicitações de inferência que se originam especificamente do seu número de telefone WhatsApp autorizado.'
        ]
      },
      {
        heading: '3. Processamento por Modelos de IA Google Gemini',
        p: 'Para gerar respostas inteligentes e em linguagem natural, o texto das mensagens recebidas é processado usando os grandes modelos de linguagem Gemini da Google DeepMind. Todas as chamadas de inferência utilizam endpoints de API corporativos protegidos por Transport Layer Security (TLS 1.3). De acordo com nossos contratos empresariais com o Google Cloud, os dados transmitidos para inferência são estritamente isolados e não são mantidos para retreinamento de modelos de fundação públicos.'
      },
      {
        heading: '4. Retenção de Dados e Gerenciamento do Ciclo de Vida',
        p: 'Mantemos registros de conversas e logs de eventos de webhook apenas enquanto sua empresa mantiver uma assinatura ativa. Após a desativação ou encerramento da conta, todos os tokens de acesso associados, entradas da base de conhecimento e históricos de conversas com clientes podem ser permanentemente excluídos mediante solicitação, em conformidade com as regulamentações aplicáveis de proteção de dados.'
      },
      {
        ...
        list: [
          ...
          'Revogação de Credenciais: Você pode atualizar ou excluir seus Tokens de Acesso Meta diretamente no painel de configurações a qualquer momento.',
  ...
  ko: {
    ...
    intro: 'Regalia AI(이하 "회사"라 칭함)는 WhatsApp Business를 위한 자율적이고 신뢰할 수 있으며 제어 가능한 고객 서비스 시스템을 전문으로 하는 엔터프라이즈 AI 자동화 기업입니다. 본 개인정보 처리방침은 귀하가 당사의 포털, 대시보드 및 AI 에이전트 엔드포인트와 상호 작용할 때 당사 플랫폼이 개인 데이터를 수집, 사용, 암호화 및 격리하는 방법을 상세히 설명합니다.',
    sections: [
      {
        ...
        items: [
          {
            sub: '직접 제공한 계정 자격 증명',
            desc: '온보딩 시 귀하가 제공하는 정보로, 비즈니스명, WhatsApp 전화번호 ID 및 Meta 액세스 토큰을 포함합니다.'
          },
          {
            sub: '자동화된 WhatsApp 웹훅 페이로드',
            desc: '공식 Meta 웹훅을 통해 당사의 FastAPI 엔드포인트로 전송되는 고객 메시지입니다. 이 페이로드에는 발신자 전화번호, 타임스탬프 및 문맥적 AI 응답을 생성하는 데 반드시 필요한 메시지 내용이 포함됩니다.'
          },
          {
            sub: '사용자 지정 지식 기반(Knowledge Base) 및 제품 카탈로그',
            desc: 'AI 응답 및 지역 사투리지역 방언 적응과 같은를 안내하기 위해 Regalia 대시보드에 업로드된 텍스트 문서, FAQ 및 제품 가격 규칙입니다.'
          }
        ]
      },
      {
        heading: '2. 철저한 데이터 격리 및 로컬 SQLite 저장소',
        p: '일반적인 공개 AI 채팅 인터페이스와 달리 Regalia는 엄격한 엔터프라이즈 데이터 테넌시 격리 원칙에 따라 운영됩니다. 모든 클라이언트 구성, 액세스 키 및 대화 로그는 암호화되어 로컬의 분리된 SQLite 저장소에 안전하게 보관됩니다. 당사는 다음을 보장합니다:',
        list: [
          '최종 고객의 전화번호 및 채팅 기록은 비즈니스 ID별로 완벽하게 분리되어 보관됩니다.',
          '어떠한 고객 상호 작용 데이터도 제3자 광고 브로커에게 판매, 공유 또는 양도되지 않습니다.',
          '귀하의 맞춤형 지식 기반은 귀하의 승인된 WhatsApp 전화번호 ID에서 발생하는 인퍼런스(추론) 요청 중에만 독점적으로 액세스됩니다.'
        ]
      },
      {
        heading: '3. Google Gemini AI 모델 처리',
        p: '지능적이고 자연스러운 언어 응답을 생성하기 위해 수신된 메시지 텍스트는 Google DeepMind의 대형 언어 모델을 사용하여 처리됩니다. 모든 인퍼런스 호출은 전송 계층 보안(TLS 1.3)으로 보호되는 엔터프라이즈 API 엔드포인트를 사용합니다. Google Cloud 엔터프라이즈 계약에 따라 인퍼런스를 위해 전송되는 데이터는 엄격히 격리되며 공개 파운데이션 모델 재학습 목적으로 저장되지 않습니다.'
      },
      {
        heading: '4. 데이터 보유 및 수명 주기 관리',
        p: '당사는 귀하의 비즈니스가 활성 구독 상태를 유지하는 동안에만 대화 기록 및 웹훅 이벤트 로그를 보관합니다. 계정 비활성화 또는 종료 시, 관련 WhatsApp 액세스 토큰, 지식 기반 항목 및 고객 상호 작용 로그는 관련 데이터 보호 법규에 따라 요청 즉시 영구적으로 파기됩니다.'
      },
      {
        ...
        list: [
          ...
          '자격 증명 철회: 언제든지 설정 패널에서 Meta 액세스 토큰을 직접 업데이트하거나 삭제할 수 있습니다.',
  ...
  hi: {
    ...
    intro: 'Regalia AI (इसके बाद "कंपनी" के रूप में संदर्भित) एक एंटरप्राइज़ AI ऑटोमेशन कंपनी है जो WhatsApp Business के लिए स्वायत्त, विश्वसनीय और नियंत्रण योग्य ग्राहक सेवा प्रणालियों में विशेषज्ञता रखती है। यह गोपनीयता नीति बताती है कि जब आप हमारे पोर्टल, डैशबोर्ड और AI एजेंट एंडपॉइंट्स के साथ इंटरैक्ट करते हैं तो हमारा प्लेटफ़ॉर्म व्यक्तिगत डेटा को कैसे एकत्र, उपयोग, एन्क्रिप्ट और अलग (isolate) करता है।',
    sections: [
      {
        ...
        items: [
          {
            ...
            desc: 'ऑनबोर्डिंग के दौरान आपके द्वारा प्रदान की गई जानकारी, जिसमें आपके व्यवसाय का नाम, WhatsApp फ़ोन नंबर ID, और Meta एक्सेस टोकन शामिल हैं।'
          },
          {
            sub: 'स्वचालित WhatsApp वेबहुक पेलोड',
            desc: 'आधिकारिक Meta वेबहुक के माध्यम से हमारे FastAPI एंडपॉइंट्स पर प्रेषित ग्राहक संदेश। इन पेलोड में प्रेषक के फ़ोन नंबर, टाइमस्टैम्प और संदेश सामग्री शामिल होती है जो प्रासंगिक AI उत्तर उत्पन्न करने के लिए आवश्यक है।'
          },
          {
            sub: 'कस्टम नॉलेज बेस और उत्पाद कैटलॉग',
            desc: 'AI प्रतिक्रियाओं और क्षेत्रीय बोलियों जैसे क्षेत्रीय बोली अनुकूलन को निर्देशित करने के लिए Regalia डैशबोर्ड पर अपलोड किए गए पाठ दस्तावेज़, अक्सर पूछे जाने वाले प्रश्न (FAQs) और उत्पाद मूल्य निर्धारण नियम।'
          }
        ]
      },
      {
        heading: '2. सख्त डेटा अलगाव और स्थानीय SQLite संग्रहण',
        p: 'सार्वजनिक AI चैट इंटरफेस के विपरीत, Regalia सख्त एंटरप्राइज़ डेटा टेनेंसी अलगाव पर काम करता है। सभी क्लाइंट कॉन्फ़िगरेशन, एक्सेस कुंजियाँ और वार्तालाप लॉग एन्क्रिप्ट किए जाते हैं और स्थानीय रूप से पृथक SQLite संग्रहण में सुरक्षित रखे जाते हैं। हम गारंटी देते हैं कि:',
        list: [
          'अंतिम ग्राहकों के फ़ोन नंबर और चैट लॉग को व्यावसायिक ID के आधार पर पूरी तरह से अलग रखा जाता है।',
          'कोई भी ग्राहक इंटरैक्शन डेटा कभी भी तीसरे पक्ष के विज्ञापन दलालों को बेचा, साझा या स्थानांतरित नहीं किया जाता है।',
          'आपका कस्टम नॉलेज बेस केवल उन अनुमान (inference) अनुरोधों के दौरान सुलभ होता है जो विशेष रूप से आपके अधिकृत WhatsApp फ़ोन नंबर ID से उत्पन्न होते हैं।'
        ]
      },
      {
        heading: '3. Google Gemini AI मॉडल प्रसंस्करण',
        p: 'बुद्धिमान और प्राकृतिक भाषा उत्तर उत्पन्न करने के लिए, आने वाले संदेश पाठ को Google DeepMind के बड़े भाषा मॉडल का उपयोग करके संसाधित किया जाता है। सभी अनुमान कॉल ट्रांसपोर्ट लेयर सुरक्षा (TLS 1.3) द्वारा संरक्षित एंटरप्राइज़ API एंडपॉइंट का उपयोग करते हैं। हमारे Google Cloud एंटरप्राइज़ समझौतों के तहत, अनुमान के लिए प्रेषित डेटा पूरी तरह से अलग रहता है और इसे सार्वजनिक फ़ाउंडेशन मॉडल के पुनर्प्रशिक्षण के लिए सहेजा नहीं जाता है।'
      },
      {
        heading: '4. डेटा प्रतिधारण और जीवनचक्र प्रबंधन',
        p: 'हम वार्तालाप रिकॉर्ड और वेबहुक ईवेंट लॉग केवल तब तक बनाए रखते हैं जब तक आपका व्यवसाय एक सक्रिय सदस्यता बनाए रखता है। खाता निष्क्रिय होने या समाप्त होने पर, सभी संबद्ध WhatsApp एक्सेस टोकन, नॉलेज बेस प्रविष्टियाँ और ग्राहक इंटरैक्शन लॉग लागू डेटा संरक्षण नियमों के अनुसार अनुरोध पर स्थायी रूप से हटाए जा सकते हैं।'
      },
      {
        ...
        list: [
          ...
          'क्रेडेंशियल निरस्तीकरण: आप किसी भी समय सेटिंग पैनल से सीधे अपने Meta एक्सेस टोकन को अपडेट या हटा सकते हैं।',
    ...
    sections: [
        ...
        items: [
          {
            ...
            desc: 'オンボーディング時に提供される情報（ビジネス名 `nama_bisnis`、WhatsApp電話番号ID 、およびMetaアクセストークン  を含みます）。'
          },
          {
      ...
      },
      {
        ...
        list: [
          ...
          '認証情報の失効：設定パネルからいつでも直接Metaアクセストークン（）を更新または削除できます。',
